...
class Persona: # Creamos una clase
    ...
    def __init__(self, nombre, apellido, edad, *args, **kwargs): # Se le llama metodo Init Dunder
        self.nombre = nombre
...
persona3 = Persona('Rogelio', 'Romero', 22, 'Teléfono', 2614445557, 'Calle Lopez', 823, 'Manzana', 77, 'casa', 18, altura=1.83, peso=105, Cfavorito='Azul', Auto='Ford', modelo=2020)
